...
namespace EWZ.Service.Helpers
{
    public static class WZEmailBuilder
    {
        public static string BuildEWZBodyForGroup(List<WZDocument> invoices)
        {
            ...
            var invoiceInfo = isPL
                ? $"Przesyłamy w załączniku elektroniczne dokumenty WZ:<br/><strong>{invoiceNumbers}</strong>"
                : $"Please find attached electronic WZ documents:<br/><strong>{invoiceNumbers}</strong>";
